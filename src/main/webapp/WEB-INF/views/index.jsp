        ...
        <section class="page-section" id="boards">
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="board-in-main" style="width:350px; height: 530px; outline :solid 15px #F0EAD5; border-radius: 10px 10px 10px 10px ">
                    ...
                    <div class="board-in-main"  style="width:350px;height: 530px; margin:auto;outline :solid 15px #F0EAD5; border-radius: 10px 10px 10px 10px ">
