		...
		success: function(obj){
		   ...
		   navigator.geolocation.getCurrentPosition((position) => {
			...
			$.each(obj, function(index,el){
			    ...
			    //마커
			    urlimg = el.lindJobGbnNm=='동물병원'?'${contextPath}/resources/img/hospital/map-pin-red2.png' :  el.lindJobGbnNm=='동물약국'? '${contextPath}/resources/img/hospital/map-pin-green.png' : '${contextPath}/resources/img/hospital/map-pin-pink.png';
