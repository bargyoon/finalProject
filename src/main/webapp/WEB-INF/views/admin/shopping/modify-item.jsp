											...
											<div class="col-md-12">
												<div class="card">
													<div class="card-header">
														<h6 class="card-title m-b-0 d-inline-block">현재상품이미지</h6>
														...
														<div class="card-body">
															<div class="drop-zone drop-img">
																<span class="drop-zone__prompt">이미지를 드래그 하거나 클릭해서
																	추가하세요</span>
																	<c:forEach items="${commandMap.files}" var="files">
																	<div class="drop-zone__origin" data-label="" style="background-image: url(${files.downloadURL});"></div>
														...
														<div class="card-body">
															<div class="drop-zone drop-spec-img">
																<span class="drop-zone__prompt">이미지를 드래그 하거나 클릭해서
																	...
																	<c:forEach items="${commandMap.files}" var="files">
																	<div class="drop-zone__origin" data-label="" style="background-image: url(${subFiles.downloadURL});"></div>
