...
<section>
		...
		<div class="petcare-back">						
				<a href="/petcare/action/action-dog"><i class="fas fa-angle-double-right"></i>  고양이 행동 의미 보러가기</a>
				<h2> 강아지 행동 의미 </h2>
				
				<div class="petcare-wrap">
					<ul class="petcare-tab-wrap">
						<li><a class="selected" href="/petcare/action/dog?1">눈</a></li>
						<li><a href="/petcare/action/dog?2">입</a></li>
						<li><a href="/petcare/action/dog?3">귀</a></li>
						<li><a href="/petcare/action/dog?4">꼬리</a></li>
						<li><a href="/petcare/action/dog?5">몸 전체</a></li>
					</ul>
